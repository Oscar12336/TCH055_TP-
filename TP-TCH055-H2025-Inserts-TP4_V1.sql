...
-- Satisfaction
-- ====================================================================
-- Initialisation de la table MOIS (comme une enumération) 
-- ------------------------------------------------------
...
INSERT INTO Adresse VALUES (4 , 789 , 'rue des tulipes' , 'Trois-Rivières' , 'CANADA' , 'T4H 2H2' ) ; 
...
-- INSETION SANS PAYS (valeur par défaut) 
...
-- -----------------------------------------------------------------------
-- Insertion des fournisseurs réguliers 
...
-- Livraison 50021 - 2 commandes 30 et 32. 30 est partie, 32 entièrement 
...
-- Livraison 50022 - Livraison de la commande 31. Livrée totalement 
...
-- Livraison 50023 - commande 33. Livrée en partie
...
-- 1 paiement pour la facture 60023. Paiment complet en espèce 
INSERT INTO Paiement (date_paiement , montant , type_paiement , id_facture) 
...
INSERT INTO Satisfaction VALUES( 100 , 'PC2000' , 5 , 'Très satisfait de mon achat.' ) ; 
INSERT INTO Satisfaction VALUES( 100 , 'LT2011' , 4 , 'Opérationnel selon mes attentes- Fait un peu de bruit' ) ; 

-- Evaluation par le client 102 ('Polo'     , 'marco') 
INSERT INTO Satisfaction VALUES(102 , 'PC2000' , 1 , 'Achat décevant, design limite. Problème lors de la livraison' ) ; 
INSERT INTO Satisfaction VALUES(102 , 'LT2011' , 3 , 'Ordinateur de bonne qualité, problème avec la livraison' ) ; 
